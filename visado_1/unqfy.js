...
class UNQfy {
  ...
  constructor(){
    this._artists= [];
    this.playlists= [];
    this.ids=[{artistId:1},{albumId:1},{trackId:1},{playlistId:1}];
  }

  artistId(){
    return this.ids[0].artistId ++;
  }
  albumId(){
    return this.ids[1].albumId ++;
  }
  trackId(){
    return this.ids[2].trackId ++;
  }
  playlistId(){
    return this.ids[3].playlistId ++;
  }
  ...
  addArtist(artistData) {
    ...
    */
    if (this._artists.find(artist => artist._name === artistData.name))
    {
      ...
      const newArtist = new artist(artistData.name, artistData.country,this.artistId()); 
  ...
  */
    const newAlbum = new album (albumData.name, albumData.year,this.albumId());
    try {
      return this.getArtistById(artistId).addAlbum(newAlbum);
    }
    catch(e){
  ...
  */
    ...
    const newTrack = new track(trackData.name, trackData.duration, trackData.genres, this.trackId());
    try {
  ...
  */
    const newPlayList = new playList(name,genresToInclude,maxDuration,this.playlistId());
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchName(object, name){
    return object.name.toLowerCase().indexOf(name.toLowerCase()) > -1;
  }

  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchPlayListByName(name){
    return this.playlists.filter(playlist => this.searchName(playlist, name));
  }

  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchArtistsByName(name){
    return this.getArtist().filter(artist => this.searchName(artist, name));
  }
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchAlbumsByName(name){
    return this.getAlbums().filter(album => this.searchName(album, name));
  }
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchTracksByName(name){
    return this.getTracks().filter(track => this.searchName(track, name));
  }
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  searchByName(name){
    return { 
      artists: this.searchArtistsByName(name), 
      albums: this.searchAlbumsByName(name), 
      tracks: this.searchTracksByName(name), 
      playlists: this.searchPlayListByName(name)
    };
  }
